        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white flex items-center justify-center rounded shadow-inner p-1 overflow-hidden">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-brand-blue text-[10px] font-black tracking-[0.2em] uppercase">Quisqueya</span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-400 text-sm">Marginal de Las Americas km 12 1/2, El Edif. #10, Los Frailes 2do, Sto. Dom. Este, R.D.</span>
              </li>
